...
//     shard_id: &str,
// ) -> Signed<DeployData> {
//     let sk = PrivateKey::from_hex(private_key_hex).expect("Invalid private key hex string");

//     let deploy_data = DeployData {
//         timestamp,
//         term: compiled_source.code,
//         phlo_limit: u64::MAX, // Equivalent to accounting.MAX_VALUE in Scala
//         phlo_price: 0,
//         valid_after_block_number: 0,
//         shard_id: shard_id.to_string(),
//     };

//     Signed::new(deploy_data, Secp256k1, sk)
// }

// Deploy creator functions for each standard contract
// pub fn registry(shard_id: &str) -> Signed<DeployData> {
//     to_deploy(
//         CompiledRholangSource::new("Registry.rho"),
//         REGISTRY_PK,
//         REGISTRY_TIMESTAMP,
//         shard_id,
//     )
...
//     to_deploy(
//         CompiledRholangSource::new("ListOps.rho"),
//         LIST_OPS_PK,
//         LIST_OPS_TIMESTAMP,
//         shard_id,
//     )
...
//     to_deploy(
//         CompiledRholangSource::new("Either.rho"),
//         EITHER_PK,
//         EITHER_TIMESTAMP,
//         shard_id,
//     )
...
//     to_deploy(
//         CompiledRholangSource::new("NonNegativeNumber.rho"),
...
//     to_deploy(
//         CompiledRholangSource::new("MakeMint.rho"),
//         MAKE_MINT_PK,
//         MAKE_MINT_TIMESTAMP,
//         shard_id,
//     )
...
//     to_deploy(
//         CompiledRholangSource::new("AuthKey.rho"),
//         AUTH_KEY_PK,
//         AUTH_KEY_TIMESTAMP,
//         shard_id,
//     )
...
//     to_deploy(
//         CompiledRholangSource::new("RevVault.rho"),
//         REV_VAULT_PK,
//         REV_VAULT_TIMESTAMP,
//         shard_id,
//     )
...
//     to_deploy(
//         CompiledRholangSource::new("MultiSigRevVault.rho"),
