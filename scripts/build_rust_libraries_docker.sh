...
RSPACE_PLUS_PLUS_AARCH64_BUILD_ARTIFACTS_PATH="target/$AARCH64_TARGET/debug"

RHOLANG_AMD64_BUILD_ARTIFACTS_PATH="target/$AMD64_TARGET/debug"
RHOLANG_AARCH64_BUILD_ARTIFACTS_PATH="target/$AARCH64_TARGET/debug"

RUST_LIBRARIES_AMD64_RELEASE_PATH="rust_libraries/docker/debug/amd64"
RUST_LIBRARIES_AARCH64_RELEASE_PATH="rust_libraries/docker/debug/aarch64"
...
cross build --profile dev --target $AARCH64_TARGET -p rspace_plus_plus_rhotypes
...
cross build --profile dev --target $AARCH64_TARGET -p rholang
