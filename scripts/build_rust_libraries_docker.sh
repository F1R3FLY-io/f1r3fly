...
RSPACE_PLUS_PLUS_AMD64_BUILD_ARTIFACTS_PATH="../rspace++/target/$AMD64_TARGET/debug"
RSPACE_PLUS_PLUS_ARM64_BUILD_ARTIFACTS_PATH="../rspace++/target/$ARM64_TARGET/debug"

RHOLANG_AMD64_BUILD_ARTIFACTS_PATH="../rholang/target/$AMD64_TARGET/debug"
RHOLANG_ARM64_BUILD_ARTIFACTS_PATH="../rholang/target/$ARM64_TARGET/debug"
