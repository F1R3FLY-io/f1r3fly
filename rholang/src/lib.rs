...
#[no_mangle]
extern "C" fn replay_get_hot_changes(runtime_ptr: *mut ReplayRhoRuntime) -> *const u8 {
    let runtime = unsafe { (*runtime_ptr).runtime.clone() };
    let hot_store_mapped = runtime.try_lock().unwrap().get_hot_changes();
...
#[no_mangle]
extern "C" fn replay_evaluate(
    runtime_ptr: *mut ReplayRhoRuntime,
    params_ptr: *const u8,
    params_bytes_len: usize,
) -> *const u8 {
    println!("\nhit rust lib replay_evaluate");
...
#[no_mangle]
extern "C" fn replay_create_checkpoint(runtime_ptr: *mut ReplayRhoRuntime) -> *const u8 {
    let runtime = unsafe { (*runtime_ptr).runtime.clone() };
    let checkpoint = runtime.try_lock().unwrap().create_checkpoint();
...
#[no_mangle]
extern "C" fn replay_create_soft_checkpoint(runtime_ptr: *mut ReplayRhoRuntime) -> *const u8 {
    // println!("\nhit rust lib create_soft_checkpoint");
    let runtime = unsafe { (*runtime_ptr).runtime.clone() };
    let soft_checkpoint = runtime.try_lock().unwrap().create_soft_checkpoint();
...
#[no_mangle]
extern "C" fn replay_revert_to_soft_checkpoint(
    runtime_ptr: *mut ReplayRhoRuntime,
    payload_pointer: *const u8,
    payload_bytes_len: usize,
) -> () {
...
#[no_mangle]
extern "C" fn replay_set_block_data(
    runtime_ptr: *mut ReplayRhoRuntime,
    params_ptr: *const u8,
    params_bytes_len: usize,
) -> () {
...
#[no_mangle]
extern "C" fn replay_set_invalid_blocks(
    runtime_ptr: *mut ReplayRhoRuntime,
    params_ptr: *const u8,
    params_bytes_len: usize,
) -> () {
...
#[no_mangle]
extern "C" fn replay_bootstrap_registry(runtime_ptr: *mut ReplayRhoRuntime) -> () {
    let runtime = unsafe { (*runtime_ptr).runtime.clone() };
    let tokio_runtime = tokio::runtime::Runtime::new().unwrap();
    tokio_runtime.block_on(async {
        bootstrap_registry_internal(runtime).await;
