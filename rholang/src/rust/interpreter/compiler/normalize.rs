...
pub fn normalize_match(
  ...
  fn handle_unary_expression(
    ...
    let sub_proc_node = p_node.child_by_field_name("proc")
  ...
  match p_node.kind() {
    ...
    "percent_percent" => handle_binary_expression(p_node, input, source_code, Box::new(EPercentPercent::default())),
    "add" => handle_binary_expression(p_node, input, source_code, Box::new(EPlus::default())),
    "minus" => handle_binary_expression(p_node, input, source_code, Box::new(EMinus::default())),
    "plus_plus" => handle_binary_expression(p_node, input, source_code, Box::new(EPlusPlus::default())),
    "minus_minus" => handle_binary_expression(p_node, input, source_code, Box::new(EMinusMinus::default())),
