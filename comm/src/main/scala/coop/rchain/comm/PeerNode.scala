...
object NodeIdentifier {
  ...
  implicit val showNodeIdentifier: Show[NodeIdentifier] = Show.fromToString[NodeIdentifier]
}
...
object PeerNode {
  implicit val showPeerNode: Show[PeerNode] = Show.fromToString[PeerNode]
